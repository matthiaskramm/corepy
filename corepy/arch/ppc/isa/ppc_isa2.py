...
# from isa2 import Instruction
from corepy.spre.spe import Instruction
...
class bx(PPCInstruction):
  instruction_type = OPCD_LI_AA_LK
  params = {'OPCD':18}

class bcx(PPCInstruction):
  instruction_type = OPCD_BO_BI_BD_AA_LK
  params = {'OPCD':16}
